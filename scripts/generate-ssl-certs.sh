...
openssl req -new -key ./config/sslcerts/key.pem -out ./config/sslcerts/csr.pem -subj "/C=US/ST=The Company State/L=The Company City/O=The Company Name/CN=localhost"
